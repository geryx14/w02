...
void Oled::updateDisplay(float voltage, float current, float power, float energy, float frequency, float pf) {
    u8g2.clearBuffer();
    u8g2.setFont(u8g2_font_5x7_tf);

    u8g2.setCursor(10, 10);  u8g2.print("PZEM Monitor");
    ...
    u8g2.setCursor(10, 60);  u8g2.print("Frekuensi: "); u8g2.print(frequency, 1); u8g2.print(" Hz");
    u8g2.setCursor(10, 63);  u8g2.print("PF       : "); u8g2.print(pf);
